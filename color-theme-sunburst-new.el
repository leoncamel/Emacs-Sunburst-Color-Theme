;;; color-theme-sunburst-new.el --- A modified version of sunburst color-theme
...
(defun color-theme-sunburst-new ()
  "A modified version of sunburst color-theme"
  (interactive)
  (color-theme-install
...
(provide 'color-theme-sunburst-new)
